...
const API_URL = `https://calm-ravine-80567.herokuapp.com/https://fruityvice.com/api/fruit/${froot}`;
const froot2 = fruits[randFruit2];
const API_URL2 = `https://calm-ravine-80567.herokuapp.com/https://fruityvice.com/api/fruit/${froot2}`;
const froot3 = fruits[randFruit3];
const API_URL3 = `https://calm-ravine-80567.herokuapp.com/https://fruityvice.com/api/fruit/${froot3}`;
