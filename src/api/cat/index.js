...
//const API_URL = `https://immense-dusk-80893-7d5edccb4ae5.herokuapp.com/https://api.thecatapi.com/v1/images/search`;
const API_URL = `/cors-proxy/https://api.thecatapi.com/v1/images/search`;
